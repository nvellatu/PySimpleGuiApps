...
def constrainedMatchPair(starts1, starts2, len1):
    indexList = []

    if not starts1: return starts2
    if not starts2: return starts1

    for index1 in starts1:
        for index2 in starts2:
            if index1 + len1 + 1 == index2:
